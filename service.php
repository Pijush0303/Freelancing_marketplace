...
<style>
  ...
  .services-container {
    ...
    z-index: 1;
    color: #fff;
    /* Text color for better contrast against gradient */
  }
  ...
  .services-container::before {
    ...
    /* Optional pattern image or texture */
    opacity: 0.1;
  ...
  .service-info {
    ...
    text-align: left;
    border-radius: 20px;
    /* Round corners of the text area */
  ...
  .service-card:hover .service-image img {
    transform: scale(1.1);
    /* Slightly increased scale for zoom effect */
  }
